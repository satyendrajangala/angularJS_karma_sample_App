...
describe('UserModule module', function () {
    ...
    describe('UserController controller', function () {
        ...
        it('scope id should be 1', inject(function ($controller, $httpBackend, _$filter_, $rootScope, _$compile_) {
            ...
            $compile = _$compile_
            filter = _$filter_;
            //checking the id value with exact
            expect(scope.ID).toBe(1);
            // mocking the data and check the scope value
            $httpBackend.when('GET', 'http://jsonplaceholder.typicode.com/posts').respond(200, mock_data);

            scope.getData();
            $httpBackend.flush();
            expect(scope.UserData).toEqual(mock_data);
        ...
        it('Check sort column', inject(function (_$filter_) {
            filter = _$filter_;
            var sortedArray = filter('orderBy')(scope.UserData, 'id')
            expect(sortedArray).
                toEqual([
                    {
                        "userId": 1,
        ...
        it('Check reverse sort column', inject(function (_$filter_) {
            filter = _$filter_;
            var sortedArray = filter('orderBy')(scope.UserData, 'id', true)
            expect(sortedArray).
                toEqual([
                    {
                        "userId": 10,
    ...
    describe('onclick of column header ', function () {
        it('Should call method on click of header colum ', inject(function ($compile, $rootScope) {
            var element = angular.element('<th scope="col" ng-click="vm.getSortData(\'id\',idflag=true)">ID</th>');
        ...
        it('Check sort column', inject(function ($compile, $rootScope) {
            var element = angular.element('<th scope="col" ng-click="vm.getSortData(\'id\',idflag=true)">ID</th>');
            var compiled = $compile(element)($rootScope);
            compiled.triggerHandler('click');
            expect(scope.UserData).toEqual([
        ...
        it('Check reverse sort column', inject(function ($compile, $rootScope) {
